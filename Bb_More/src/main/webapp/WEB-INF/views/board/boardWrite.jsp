...
<section class="page-wrapper">
	<div class="title1">
		<i class="fa-solid fa-pen fa-2x i-write"></i><h3 class="title1-text"><b>이용후기 작성</b></h3>
	</div>
				...
				<div class="contact-form col-md-6 form-style">
					<form id="contact-form" method="post" action="" role="form">
						...
						<div class="form-group">
							<input type="text" class="form-control" value="${sessionScope.u_id}" id="u_id" name="name" disabled>
						</div>
						
						<div class="form-group">
							<input type="text" placeholder="Title" class="form-control" id="b_title">
						</div>
						
						<div class="form-group">
							<textarea rows="6" placeholder="Content" class="form-control" id="b_content"></textarea>	
						</div>
					</form>
				</div>
				<!-- ./End Contact Form -->
...
<div class="register">
	<button class="button-28" role="button" onclick="register()">등록하기</button>
</div>
<div class="boardList">
	<button class="button-28 btn-boardList" role="button" onclick="boardList()">목록</button>
</div>
</section>	
...
<script type="text/javascript">
	...
	{		
		...
		if($.trim($('#b_content').val()).length <= 0)
		{
			swal("내용을 입력해주세요");
		}
...
// 		    	u_id: '${sessionScope.user.u_id}',
			...
			success: function(code)
			{
				if(code === 0)
				{
					swal("게시물 등록 중 오류가 발생했습니다.");
				}
				else if(code === 1)
				{
					swal("게시물 등록이 완료되었습니다.")
					.then(() => {						
