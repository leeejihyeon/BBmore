...
<title>BBmore</title>
	...
	<link rel="stylesheet" href="/resources/css/changeAddress.css">
	        		...
	        		<div class="media">
	          			<div class="media-body">
							<ul class="user-profile-list profile-inner"> 
								...
								<li>
									<span>Phone:</span>
									${sessionScope.u_phone }
								</li> 
								<li>
									<span>Address:</span>
									<input type="text" id="u_address" placeholder="주소 입력" class="address-style">, 
									<input type="text" id="u_address_sub" placeholder="상세주소 입력" class="address-style">
									<button type="button" class="button-28" role="button" onclick="modifyAddress()">변경</button>
								</li>
							</ul>
	          			</div>
	        		</div>
...
<script type="text/javascript">
	function modifyAddress()
	{
		...
		let u_address_sub = $("#u_address_sub").val();
		
		$.ajax
		({
			type: "POST",
			url: "/myb/changeAddressPrco",
			dataType: "JSON",
			data:
			{
				u_address: u_address,
				u_address_sub: u_address_sub
			},
